...
/* ---------------- PROJECTS DATA ---------------- */ const projects = [
    ...
    },
    {
        ...
        description: "A full-stack AI-powered chatbot that allows users to upload documents and ask questions directly from their content. The system leverages Hugging Face APIs and context-based prompting to simulate Retrieval-Augmented Generation (RAG), enabling accurate, context-aware responses.",
        images: aiImages,
    ...
    },
    {
        ...
        description: "A Java-based web application built using JSP, Servlets, JDBC, and Bootstrap to manage shipping company client records.",
        images: shipImages,
    ...
    },
    {
        ...
        description: "A Flutter-based social networking app with real-time chat and Firebase backend.",
        images: [
            "/talkr2.jpeg",
            "/talkr3.jpeg",
            "/talkr4.jpeg",
...
/* ---------------- PROJECT CARD ---------------- */ const ProjectCard = ({ project, index })=>{
    ...
    const currentImage = project.images && project.images.length > 0 ? project.images[currentSlide % project.images.length] : null;
